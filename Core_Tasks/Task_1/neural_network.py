...
X_train_1_scratch = X_train_1.T  # Change (800,2) to (2, 800)
X_test_1_scratch = X_test_1.T  # Change (100, 2) to (2, 100)
y_train_1_scratch = np.array(y_train_1).reshape(-1, 1).T  # Change (800,) to (1, 800)
y_test_1_scratch = np.array(y_test_1).reshape(-1, 1).T  # Change (100,) to (1, 100)

# Subtask 2: Training and Prediction - First Training Set
# Training the Neural Network - Training set
W_train_1, b_train_1, W_train_2, b_train_2 = train_neural_network(X_train_1_scratch, y_train_1_scratch)

# Predicting outcomes - Training set and Testing set
y_pred_train_scratch_1 = predict(X_train_1_scratch, W_train_1, b_train_1, W_train_2, b_train_2)
y_pred_test_scratch_1 = predict(X_test_1_scratch, W_train_1, b_train_1, W_train_2, b_train_2)

# Getting accuracies - Training set and Testing set
accuracy_train_scratch_1 = accuracy(y_train_1_scratch, y_pred_train_scratch_1)
accuracy_test_scratch_1 = accuracy(y_test_1_scratch, y_pred_test_scratch_1)
...
best_lr_1, best_hidden_size_1, best_accuracy_1 = tune_hyperparameter(X_train_1_scratch, y_train_1_scratch,
                                                                     X_test_1_scratch, y_test_1_scratch,
                                                                     learning_rates, hidden_sizes)
print("Best learning rate for Task 1:", best_lr_1)
print("Best hidden size for Task 1:", best_hidden_size_1)
...
# Predicting outcomes - Training set and Testing set
y_pred_train_mlp_1 = mlp.predict(X_train_1)
y_pred_test_mlp_1 = mlp.predict(X_test_1)

# Getting accuracies - Training set and Testing set
accuracy_train_mlp_1 = accuracy_score(y_train_1, y_pred_train_mlp_1)
accuracy_test_mlp_1 = accuracy_score(y_test_1, y_pred_test_mlp_1)

# Printing accuracies - Training set and Testing set
print("Accuracy on Training Set 1 (Scikit-Learn):", accuracy_train_mlp_1)
print("Accuracy on Test Set 1 (Scikit-Learn):", accuracy_test_mlp_1)
