...
weights_2, bias_2 = fit_logistic_regression(X_train_2, y_train_2, learning_rate=0.75)

# Predicting outcomes - Training set and Testing set
y_pred_train_scratch_2 = predict(X_train_2, weights_2, bias_2)
y_pred_test_scratch_2 = predict(X_test_2, weights_2, bias_2)

# Getting accuracies - Training set and Testing set
accuracy_train_scratch_2 = accuracy(y_train_2, y_pred_train_scratch_2)
accuracy_test_scratch_2 = accuracy(y_test_2, y_pred_test_scratch_2)
...
best_lr_2, best_accuracy_2 = tune_hyperparameter(X_train_2, y_train_2, X_test_2, y_test_2, learning_rates)
...
model_sklearn.fit(X_train_2, y_train_2)

# Predicting outcomes - Training set and Testing set
y_pred_train_sklearn_2 = model_sklearn.predict(X_train_2)
y_pred_test_sklearn_2 = model_sklearn.predict(X_test_2)

# Get accuracies - Training set and Testing set
accuracy_train_sklearn_2 = accuracy_score(y_train_2, y_pred_train_sklearn_2)
accuracy_test_sklearn_2 = accuracy_score(y_test_2, y_pred_test_sklearn_2)

# Printing Accuracies
print("Accuracy on Training Set 2 (Scikit-Learn):", accuracy_train_sklearn_2)
print("Accuracy on Test Set 2 (Scikit-Learn):", accuracy_test_sklearn_2)
